<?php
	...
	if(mysqli_num_rows($result)>0){
		// var_dump($user_info['password']); //password for this user in our db
		// var_dump($password); //password inputted by the user in the login form
	 	if($user_info['password'] !=$password) {
		die('login_failed'); //password does not match the inputted password
		} else {
